...
def create_task():
    response_data = {
        "success": True, "user_id": 3, "task_id": 1}
    return jsonify(response_data)
...
def get_requests():
    ...
    tasks = [
        ...
        {"task_id": 5, "title": "【ダミー】機械翻訳の評価", "status": "50%", "created_at": "2025-08-01", "due_date": "2025-08-07"},
        {"task_id": 6, "title": "【ダミー】画像アノテーション作業", "status": "100%", "created_at": "2025-07-15", "due_date": "2025-07-25"},
        {"task_id": 7, "title": "【ダミー】テキストデータの分類", "status": "20%", "created_at": "2025-08-05", "due_date": "2025-08-20"},
        {"task_id": 8, "title": "【ダミー】音声データの文字起こし", "status": "依頼準備中", "created_at": "2025-07-20", "due_date": "2025-07-30"},
    ]
